    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="box box-info">
                ...
                <!-- /.box-header -->
                <div class="box-body">
                    <form class="form-horizontal" action="{{url('admin-panel/commonmodule/active-app')}}" method="POST">
                        {{ csrf_field() }}
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                            ...
                                            <div class="col-lg-3">
                                                @foreach ($apps as $app)
                                                    <label class="control-label col-sm-2" for="lang"><strong>(&nbsp;{{ $app->title }}&nbsp;)</strong></label>
                                                    <br>
                                                    <br>
                                                    <label><input type="radio" name="{{ $app->title }}_Activate" value="1" @if($app->active == 1) checked @endif> {{ __('commonmodule::main.activate') }}</label>
                                                    &nbsp;
                                                    <label><input type="radio" name="{{ $app->title }}_Activate" value="0" @if($app->active == 0) checked @endif> {{ __('commonmodule::main.deactivate') }}</label>
                                                    <hr>
                                                @endforeach
                                            </div>
                                        </div>
