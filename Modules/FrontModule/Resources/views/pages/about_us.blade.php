        ...
        <div class="row">
            <div class="col-xl-6">
                <div class="about-image-holder wow fadeInLeft" data-wow-delay="900ms">
                    <img style="width:570px;height:321.77px;" src="{{ asset('/images/config/'.$config['about']) }}" alt="Awesome Image">
                </div>
            </div>
            <div class="col-xl-6">
                <div class="inner-content">
                    <div class="sec-title">
                        ...
                        <h1>{{ $config['about_us_message_'.App()->getLocale()] }}</h1>
                    </div>
                    <div class="about-text-holder">
                        {!! $config['about_index_'.App()->getLocale()] !!}
