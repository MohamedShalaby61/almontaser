                    ...
                    <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12">
                        <div class="single-blog-post">
                            <div class="img-holder">
                                <img style="height: 243px;width: 370px" src="{{ asset('') }}/images/service/{{ $service->photo }}" alt="Awesome Image">
                            </div>
                            <div class="text-holder">
                                <div class="meta-box">
                                    <ul class="meta-info">
                                        <li><a href="#">{{ $service->created_at->diffForHumans() }}</a></li>
                                    </ul>
                                </div>
                                <h3 class="blog-title"><a href="{{ route('single_service',str_replace(' ','-',$service->title)) }}">{{ $service->title }}</a></h3>
                                <div style="width: 300px;height: 48px;" class="text-box">
                                    {!! substr($service->description,0,150) !!}
                                </div>
                                <div class="readmore-button">
                                    <a class="btn-two" href="{{ route('single_service',str_replace(' ','-',$service->title)) }}"><span class="flaticon-next"></span>{{ __('frontmodule::front.con_read') }}</a>
                                </div>
                            </div>
                        </div>
                    </div>
